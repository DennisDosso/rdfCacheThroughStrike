 ...
 *
 * java -cp rdfCreditRe-virtuoso.jar:./lib/* test/virtuoso/TestRemoteVirtuosoConnection
 * */
public class TestRemoteVirtuosoConnection {
    public static void main(String[] args) {
        ...
        String dbUri = "https://wikidata.org";
        String user = "dba";
        String password = "dossodba";
